...
export default function PaymentSuccess() {
  ...
  if (!paymentData.isValid) {
    return (
      <div className="min-h-screen bg-light-bg flex items-center justify-center font-sans overflow-x-hidden">
        <div className="max-w-md mx-auto text-center px-4">
          <div className="section-frame bg-[rgba(255,251,245,0.86)] rounded-[2rem] shadow-2xl p-6 sm:p-8 overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto text-center">
          <div className="section-frame bg-[rgba(255,251,245,0.86)] rounded-[2rem] shadow-2xl p-6 sm:p-8 lg:p-12 overflow-hidden">
            ...
            <div className="bg-light-elevated border border-light-border rounded-xl p-6 mb-8">
              <h3 className="text-lg font-semibold text-light-text mb-4 flex items-center justify-center">
